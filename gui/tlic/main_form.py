"""Main application window for the Python TLIC port (v1.0)."""
...
class MainForm(ttk.Frame):
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Label(top, text="v1.0", foreground="#0d47a1", font=("Segoe UI", 11, "bold")).grid(row=0, column=2, sticky="e")
    ...
    def _load_default_data(self) -> None:
        ...
        self.line_rate_tab.set_conductors(self.phase_conds)
